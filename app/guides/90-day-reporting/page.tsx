...
const FAQS = [
  ...
  {
    question: "What if you lose your 90-Day Report receipt?",
    answer:
            ...
            <div className="mt-8 sm:mt-10 space-y-8">
              <section>
                ...
                <p className="mt-2 text-slate-700">
                  ...
                  retirement, marriage, education, DTV, and Thailand Elite visas.
                  </p>
              </section>
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="rounded-2xl border border-violet-200 bg-violet-50/30 p-5">
                    ...
                    <p className="mt-1 text-slate-700">
                      ...
                      use the online system. The system can be unreliable - submit early in case it fails.
                    </p>
                    <a
                      href={TM47_PORTAL}
                      target="_blank"
                  ...
                  <div className="rounded-2xl border border-violet-200 bg-violet-50/30 p-5">
                    ...
                    <div className="mt-2 space-y-2 text-slate-700">
                      ...
                      <ol className="list-decimal space-y-1 pl-5 text-sm">
                        ...
                        <li>
                          Include an envelope with a 10-baht stamp and your return address so immigration can send back the
                          lower part of TM.47 for your records and next notification.
                        </li>
                        <li>
                          Send all documents by registered mail, keep the registration receipt, and mail at least 15 days
                          before your due date to the immigration checkpoint responsible for your local area.
                        </li>
                      </ol>
                      <a
                        href="https://www.immigration.go.th/en?page_id=1666"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 text-sm font-medium text-violet-700 underline underline-offset-2"
                      >
                        Source: Thai Immigration Bureau <ExternalLink className="h-3.5 w-3.5" />
                      </a>
                    </div>
                  </div>
                ...
                <div className="mt-4 space-y-3">
                  {FAQS.map((faq) => (
                    <details key={faq.question} className="group rounded-2xl border border-slate-200 bg-white px-4 py-3">
                      <summary className="cursor-pointer list-none pr-6 text-base font-bold text-slate-900">
