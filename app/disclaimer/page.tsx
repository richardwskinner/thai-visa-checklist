    ...
    <div className="min-h-screen bg-[#eef3fb]">
      <div className="mx-auto w-full max-w-4xl px-5 py-10">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          <h1 className="text-center text-4xl font-extrabold tracking-tight text-slate-900">Disclaimer</h1>

          <div className="mt-8 space-y-6 text-slate-700">
            <section>
              <h2 className="text-xl font-extrabold text-slate-900">General Information Only</h2>
            ...
            <section>
              <h2 className="text-xl font-extrabold text-slate-900">No Guarantee of Approval</h2>
              <p className="mt-2 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-extrabold text-slate-900">Requirements Can Change</h2>
              <p className="mt-2 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-extrabold text-slate-900">No Government Affiliation</h2>
              <p className="mt-2 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-extrabold text-slate-900">Use at Your Own Risk</h2>
              <p className="mt-2 leading-relaxed">
